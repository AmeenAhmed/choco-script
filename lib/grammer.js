...
var grammer = {
	'lex': {
		'rules': [
            ...
            ["lambda(?![a-zA-Z0-9_$])",                                        "return 'LAMBDA';"],
	...
	"bnf" : {
        ...
        "lambda_decl":    [
                            ["LAMBDA ( ) statements ", "$$ = {type:'lambda', name:null, args: null, block: $4};"],

                            ["LAMBDA ( func_decl_list ) statements ", "$$ = {type:'lambda', name:null, args: [$3], block: $5};"],
                        ],
        ...
        "class_statement": [
                                ...
                                ["func_decl", "$$={type:'class_func_decl', visibility:'public', val:$1}"],
                                ["var_decl ", "$$={ type:'class_var_decl', visibility:'public', val:$1};"],
                            ],
