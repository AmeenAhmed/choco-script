...
var grammer = {
	'lex': {
		'rules': [
            ...
            ["import(?![a-zA-Z0-9_$])",                                              "return 'IMPORT';"],

            ["module(?![a-zA-Z0-9_$])",                                              "return 'MODULE';"],

            ["def(?![a-zA-Z0-9_$])",                                              "return 'DEF';"],

            ["end[\\n]*(?![a-zA-Z0-9_$\\(\\)])",                                              "return 'END';"],

            ["to(?![a-zA-Z0-9_$])",                                              "return 'TO';"],            

            ["self(?![a-zA-Z0-9_$])",                                              "return 'SELF';"],            
	...
	"bnf" : {
        ...
        "forStatement": [
         ...
         "ternery":      [
                             ["exp ? exp : exp", "$$={type:'ternery', 'condition':$1, 'truthy':$3, 'falsy':$5}"], 

                         ],

        "func_call_args_list": [
                                    [", exp func_call_args_list", "$$=[$2,$3];"], 
                                    [", func_decl func_call_args_list", "$$=[$2,$3];"], 
                                    [", exp", "$$=$2;"],
                                    [", func_decl", "$$=$2;"]
                                ],

        "func_call_list":   [
                                ["exp func_call_args_list", "$$=[$1, $2];"],
                                ["func_call func_call_args_list", "$$=[$1, $2];"],
                                ["new func_call_args_list", "$$=[$1, $2];"],
                                ["func_decl func_call_args_list", "$$=[$1, $2];"],
                                ["exp", "$$=$1"],
                                ["func_call", "$$=$1"],
                                ["new", "$$=$1"],
                                ["func_decl", "$$=$1"],
        ...
        "func_decl_args_list": [
                                    [", identifier func_decl_args_list", "$$=[$2,$3];"], 
                                    [", identifier", "$$=$2;"]
                                ],

        "func_decl_list":   [
                                ["identifier func_decl_args_list", "$$=[$1, $2];"],
                                ["identifier", "$$=[$1]"],
                                ["", "$$=null"]
                            ],
        ...
        "func_decl":    [
                            ...
                            ["DEF IDENTIFIER ( func_decl_list ) END", "$$ = {type:'func', name:$2, args: $4, block: null};"],

                            ["DEF ( func_decl_list ) END", "$$ = {type:'func', name:null, args: $3, block: null};"],

                            ["DEF ( func_decl_list ) statements END", "$$ = {type:'func', name:null, args: $3, block: $5};"],

                            ["DEF IDENTIFIER ( func_decl_list ) statements END", "$$ = {type:'func', name:$2, args: $4, block: $6};"],
                        ],
        ...
        "this":         [
                            ...
                            ["SELF . assign", "$$={type:'this', val:$3}"],
                            ["SELF . identifier", "$$={type:'this', val:$3}"],
                            ["SELF . dot", "$$={type:'this', val:$3}"],
                            ["SELF", "$$={type:'this', val:null}"]
                        ],
        ...
        "if_construct":     [
                                ...
                                ["IF ( has_keyword ) code_block ELSE code_block", "$$={type:'if', exp:$3, if_block:$5,  else_block:$7};"],
                            ],
        "fordo":        [
                            ["FOR ( forStatements ; forStatements ; forStatements ) code_block", "$$={type:'for', exp1:$3, exp2:$5, exp3:$7, block:$9}"],

                            ["FOR assign TO NUMBER DEF statements END", "$$={type:'forto', assign:$2, to:$4, block:$6}"]
        ...
        "assign":     [
                            ["IDENTIFIER = ternery", "$$ = {type: 'assignment', 'var': $1, val: $3};"],
        ...
        "dot":      [
                        ...
                        ["IDENTIFIER . array_access", "$$={type:'member', parent: {type: 'identifier', val: $1}, child:$3}"],
        ...
        "import":   [
                        ["IMPORT string", "$$={type:'import', val:$2}"]  
                    ],

        "module":   [
                        ["MODULE string", "$$={type:'module', val:$2}"]    
                    ],

        "using":    [
                        ["USING string", "$$={type:'using', val:$2}"]
                    ],
